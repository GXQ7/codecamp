...
- cons: 
![Circular LL](images\CircularLL.png)
...
# Array
- an indexable, fixed size, static sturtcure containing a list of the same type in contiguous memory (primitive or reference)
