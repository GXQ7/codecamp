...
- cons: static fixed size data structure, unoccupied space → front of the queue will eventually reach the end
...
- applications: CPU scheduling, grph algorithms, queue applications where priority is concerned
